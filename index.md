Administration:
- [HOWTO run LLM using Ryzen AI NPU on Debian 13](./administration/run-llm-using-ryzen-npu.md)
...
- [HOWTO make a bootable USB stick from isolinux ISO](./administration/make-boot-usb-from-iso.md)
